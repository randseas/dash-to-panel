...
const Preferences = class {
  ...
  _bindSettings() {
    ...
    let maybeSetPanelLengthScaleValueChange = (value) => {
      ...
      if (value != -1)
        connectValueChanged(panel_length_scale, panelLengthScale);
      ...
      .connect("clicked", () => {
        ...
        let dialog = this._createPreferencesDialog(
          ...
          () => {
            ...
            this._settings.set_value(
              "intellihide-show-in-fullscreen",
              this._settings.get_default_value("intellihide-show-in-fullscreen")
            );
            this._settings.set_value(
              "intellihide-show-on-notification",
              this._settings.get_default_value(
            ...
            this._settings.set_value(
              "intellihide-pressure-threshold",
              this._settings.get_default_value("intellihide-pressure-threshold")
            );
            this._builder
              .get_object("intellihide_pressure_threshold_spinbutton")
              .set_value(
            ...
            this._settings.set_value(
              "intellihide-enable-start-delay",
              this._settings.get_default_value("intellihide-enable-start-delay")
            );
            intellihideStartDelayButton.set_value(
              this._settings.get_int("intellihide-enable-start-delay")
            );
        ...
        let dialog = this._createPreferencesDialog(
          ...
          () => {
            ...
            this._settings.set_value(
              ...
              this._settings.get_default_value("window-preview-title-font-size")
            );
            this._builder
      ...
      .connect("clicked", () => {
        ...
        let dialog = this._createPreferencesDialog(
          ...
          () => {
            ...
            let rgba = new Gdk.RGBA();
            rgba.parse(
              this._settings.get_string("group-apps-label-font-color")
            );
            this._builder
              .get_object("group_apps_label_font_color_colorbutton")
              .set_rgba(rgba);
            ...
            this._settings.set_value(
              "group-apps-underline-unfocused",
              this._settings.get_default_value("group-apps-underline-unfocused")
            );
            this._settings.set_value(
              "group-apps-use-launchers",
        ...
        let dialog = this._createPreferencesDialog(
          ...
          () => {
            ...
            this._settings.set_value(
              ...
              this._settings.get_default_value("secondarymenu-contains-appmenu")
            );
            this._settings.set_value(
    ...
    versionLinkButton.set_uri(
      `${this._metadata.url}/${
        this._metadata.commit
          ? `commit/${this._metadata.commit}`
          : `releases/tag/v${this._metadata.version}`
      }`
    );
